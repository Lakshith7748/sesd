...
router.get('/mine', authenticate, authorize(UserRole.CLIENT), projectController.getMyProjects);

router.post('/', authenticate, authorize(UserRole.CLIENT), projectController.createProject);

router.put('/:projectId', authenticate, authorize(UserRole.CLIENT), projectController.editProject);
