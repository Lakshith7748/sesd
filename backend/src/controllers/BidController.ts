...
export class BidController {
  ...
  getBidsForProject = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
  ...
  getMyBids = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      const freelancerId = req.user!.userId;
